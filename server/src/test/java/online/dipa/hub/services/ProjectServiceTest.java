...
class ProjectServiceTest {
    ...
    class CreatePermanentProjectTasks {
        ...
        void should_create_final_project_task() {
            ...
            ProjectTaskEntity projectTaskTemp = new ArrayList<>(Objects.requireNonNull(projectTaskTemplateRepository.findByMaster().orElse(null))
                                                                       .getProjectTasks()).stream().filter(p -> p.getFinalProjectTask()!= null).findFirst().get();
            ProjectTaskEntity newProjectTask = new ProjectTaskEntity(projectTaskTemp);
            newProjectTask.setProjectTaskTemplate(projectTaskProject);
            ...
            assertThat(new ArrayList<>(finalProjectTaskTemp.getFinalProjectTasks()).get(0).getTitle())
                    .isEqualTo(projectTaskTemp.getFinalProjectTask().getTitle());
        }
    ...
    class GetProjectTasks {
        ...
        void should_return_non_permanent_project_task() {
            ...
            // THEN
            assertThat(nonPermanentProjectTasks).isNotEmpty().hasSize(12);
    ...
    class SortOrderProjectTasks {
        ...
        void should_return_new_sort_order_final_project_tasks() {
            ...
            List<FinalProjectTask> projectTasks = projectService.getFinalProjectTasks(testProject.getId());
            projectTasks.get(0).setSortOrder(2L);
            ...
            // THEN
            then(finalProjectTaskRepository.getById(projectTasks.get(0).getId())).returns(2L,
