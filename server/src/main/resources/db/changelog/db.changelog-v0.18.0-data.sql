...
--changeset id:update-project-flow-step-remove-[PL]-from-name context:itzbund
UPDATE project_flow_step
SET name=REPLACE(name, '[PL] ', '')


--changeset id:update-external_link-elbe-rename context:itzbund
UPDATE external_link
SET name = 'Bestellungen'
WHERE id=10 AND name = 'Elbe'

--changeset id:update-external_link-rahmenvertraege-itzbund-rename context:itzbund
UPDATE external_link
SET name = 'Laufende Rahmenverträge'
WHERE id=21 AND name = 'Rahmenverträge des ITZBund'

--changeset id:update-external_link-kaufhaus-des-bundes-rename context:itzbund
UPDATE external_link
SET name = 'Informationen zu Rahmenverträgen'
WHERE id=22 AND name = 'Kaufhaus des Bundes'

--changeset id:update-project-flow-step-action-beauftragung-share-point-rename context:itzbund
...
--changeset id:update-external_link-isar-rename context:itzbund
UPDATE external_link
SET name = 'ERP / Ressourcen-Verwaltung'
WHERE id=11 AND name = 'iSAR'

--changeset id:update-project-flow-step-action-kommunikation-ohne-sina-rename context:itzbund
UPDATE project_flow_step_action
...
--changeset id:update-external_link-kommunikation-ohne-sina-rename context:itzbund
UPDATE external_link
SET name = 'Videokonferenz-Tool'
WHERE id=19 AND name = 'WebEx'

--changeset id:insert-external_link-collaboration-tool context:itzbund
INSERT INTO external_link (id, name, description, url, img, category, sort_order)
VALUES (26, 'Kollaborations-Tool', '', '', null, null, 26)

--changeset id:insert-project-flow-step-action-link-collaboration-tool context:itzbund
INSERT INTO project_flow_step_action_link (project_flow_step_action_id, external_link_id)
VALUES (8, 26)

--changeset id:update-project-flow-step-auftraggeber-managen-rename context:itzbund
UPDATE project_flow_step
SET name = 'Kunden managen'
WHERE id=5 AND name = 'Auftraggeber managen'

--changeset id:update-project-flow-step-action-kontaktdaten-anderer-behoerden-rename context:itzbund
UPDATE project_flow_step_action
...
--changeset id:update-external_link-adressbuch-bundesverwaltung-rename context:itzbund
UPDATE external_link
SET name = 'CRM / Adressbuch externer Kontakte'
WHERE id=20 AND name = 'Adressbuch der Bundesverwaltung'

--changeset id:update-external_link-social-intranet-bund-rename context:itzbund
UPDATE external_link
SET name = 'Informationen zu Social Media Kanälen'
WHERE id=16 AND name = 'Social Intranet des Bundes'

--changeset id:insert-external_link-social-media-channel-1 context:itzbund
INSERT INTO external_link (id, name, description, url, img, category, sort_order)
VALUES (27, 'Social Media Kanal 1', '', '', null, 'Weiteres', 27)

--changeset id:insert-project-flow-step-action-link-social-media-channel-1 context:itzbund
INSERT INTO project_flow_step_action_link (project_flow_step_action_id, external_link_id)
VALUES (10, 27)

--changeset id:update-project-flow-step-action-vertraege-externer--erstellung-leistungsnachweise-rename context:itzbund
UPDATE project_flow_step_action
...
--changeset id:update-external_link-aedl-rename context:itzbund
UPDATE external_link
SET name = 'Vertragsverwaltung'
WHERE id=12 AND name = 'AeDL'

--changeset id:update-external_link-itr4web-rename context:itzbund
UPDATE external_link
SET name = 'ERP / Ressourcen-Verwaltung'
WHERE id=13 AND name = 'ITR4Web'

--changeset id:update-external_link-jira-rename context:itzbund
UPDATE external_link
SET name = 'Aufgaben-Verwaltung', description = 'Projektaufgaben verwalten', img = null
WHERE id=1 AND name = 'Jira'

--changeset id:update-external_link-vmxt-produktvorlagen-rename context:itzbund
UPDATE external_link
SET name = 'Dokumentvorlagen'
WHERE id=18 AND name = 'VMXT Produktvorlagen'

--changeset id:update-external_link-wiki-projektleitung-rename context:itzbund
UPDATE external_link
SET name = 'Projektleitungs-Infos'
WHERE id=3 AND name = 'Wiki Projektleitung (II A 1)'

--changeset id:update-external_link-it-planung-itr4web-rename context:itzbund
UPDATE external_link
SET name = 'Infos zu Planungsverfahren'
WHERE id=5 AND name = 'IT-Planungsverfahren und ITR4Web'

--changeset id:update-external_link-projekte-itzbund-rename context:itzbund
UPDATE external_link
SET name = 'Projekte in unserer Organisation'
WHERE id=14 AND name = 'Projekte im ITZBund'

--changeset id:delete-external-link-agile-swe-itzbund context:itzbund
DELETE FROM external_link
WHERE id=15 AND name = 'Agile SWE im ITZBund'

--changeset id:delete-external-link-ggb context:itzbund
DELETE FROM external_link
WHERE id=17 AND name = 'GGB'


--changeset id:update-project-task-form-field-join-contact-person-and-department context:itzbund
...
--changeset id:delete-project-task-form-field-taskArea context:itzbund
DELETE FROM project_task_form_field
WHERE key = 'taskArea'

--changeset id:update-project-task-01-rename context:itzbund
UPDATE project_task
...
--changeset id:delete-project-task-02 context:itzbund
DELETE FROM project_task
WHERE task_number = 2

--changeset id:update-project-task-03-rename context:itzbund
UPDATE project_task
...
--changeset id:update-project-task-form-field-documentationLink-rename context:itzbund
UPDATE project_task_form_field
SET label = 'Link zum ERP-System'
WHERE key = 'documentationLink' AND label = 'Link zur iSAR'

--changeset id:update-project-task-form-field-colleague-rename context:itzbund
UPDATE project_task_form_field
SET key = 'teamMember', label = 'Teammitglied'
WHERE key = 'colleage' AND label = 'Teamkollege'

--changeset id:update-project-task-form-field-eAkte-rename context:itzbund
UPDATE project_task_form_field
...
--changeset id:update-non_permanent_project_task-07-rename context:itzbund
...
--changeset id:update-non_permanent_project_task-08-rename context:itzbund
UPDATE non_permanent_project_task
SET title = 'Abrechnungstool für externe Aufwände einrichten'
WHERE title = 'AeDL einrichten'

--changeset id:update-project-task-08-explanation context:itzbund
UPDATE project_task
...
--changeset id:delete-all-project-task-09 context:itzbund
DELETE FROM project_task
WHERE task_number = 9 AND explanation = 'Tracking der monatlichen Aufwände und Zahlungen'

--changeset id:update-project-task-12-explanation context:itzbund
UPDATE project_task
...
--changeset id:update_project-task-15-description context:itzbund
UPDATE project_task
SET explanation = ''
